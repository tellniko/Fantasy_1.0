        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FootballClubInfos_FootballClubs_ClubId",
                        column: x => x.ClubId,
                        principalTable: "FootballClubs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FootballPlayers_FootballPlayerPositions_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FootballPlayerInfos_FootballPlayers_PlayerId",
                        column: x => x.PlayerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FootballClubInfos_ClubId",
                table: "FootballClubInfos",
                column: "ClubId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FootballPlayerInfos_PlayerId",
