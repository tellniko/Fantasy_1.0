...
namespace Fantasy.Services.Administrator.Implementations
{
    public class DatabaseService : IDatabaseService
    {
        ...
        {
            var fileContentPlayer = File.ReadAllText("wwwroot/JsonFiles/players.json");
            var fileContentPlayerInfo = File.ReadAllText("wwwroot/JsonFiles/playersInfos.json");
            ...
            //var players2 = this.db.FootballPlayers.ToList();
            //foreach (var player in players2)
            //{
            //    var priceDouble = random.NextDouble();
            //    Console.WriteLine(priceDouble);
            //    var priceInt = random.Next(4, 12);
            //    Console.WriteLine(priceInt);

            //    var price = (decimal)(priceInt + priceDouble);
            //    player.Price = price;
            //}
            //this.db.SaveChanges();
            #endregion
        ...
        public string SeedStatistics()
        {
            ...
            #region Create Json Files With Statistics
