...
namespace Fantasy.Services.Models
{
        ...
        ,IHaveOffcidesStatistics
    {
        ...
        [Points(Units = 5)] public short SuccessfulFiftyFifties { get; set; }
        ...
        [Points(Units = 8)] public short ThroughBalls { get; set; }

        [Points(Units = 80)] public short Goals { get; set; }
        ...
        [Points(Units = 10)] public short Shots { get; set; }
